...
export {
    _math as math,
    _arrToObj as arrToObj,
    _objToArr as objToArr,
    _radianToDegree as radianToDegree,
    _degreeToRadian as degreeToRadian,
    _formatAngle as formatAngle,
    _minus as minus,
    _add as add,
    _times as times,
    _divide as divide,
    ...
    _areaOf as areaOf,
    _ratioOf as ratioOf,
    _angleBetween as angleBetween,
    _angleOf as angleOf,
    _vectorOf as vectorOf,
    _rotate as rotate,
    _unRotate as unRotate,
};
